package com.solarie.config;

import com.solarie.shiro.authc.ShiroRealm;
import com.solarie.shiro.authc.aop.JwtFilter;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/sys/user/listByRoleId", "anon"); //用户信息
