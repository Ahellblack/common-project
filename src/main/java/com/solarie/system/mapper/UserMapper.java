package com.solarie.system.mapper;

import org.apache.ibatis.annotations.*;
import tk.mybatis.mapper.common.Mapper;
import com.solarie.system.db.User;
...
public interface UserMapper extends Mapper<User>{
	...
	@Results(id = "progItemMap",value = {
		...
		@Result(property = "roles",javaType = List.class,column = "id",many = @Many(select="com.solarie.system.mapper.RoleMapper.getByUserId")),
		@Result(property = "orgs",javaType = List.class,column = "id",many = @Many(select="com.solarie.system.mapper.OrgMapper.getByUserId"))
	})
